...
import com.pardyl.shortener.services.ExternalUser
...
@Configuration
class CasConfig(
    @Value("\${shortener.site.address:}") private val siteUrl: String,
    @Value("\${shortener.cas.url:}") private val casUrl: String,
    @Value("\${shortener.cas.role.attribute:}") private val casRoleAttribute: String,
    @Value("\${shortener.cas.role.admin:}") private val casAdmin: String,
    @Value("\${shortener.cas.role.mod:}") private val casMod: String,
